...
function checkNumber() {
  if (randomNumber == guessInputEl.value) {
    ...
    messageEl.textContent = 'MALADES KALLANGA QOYIL ! 🥇'
    ...
    messageEl.textContent = 'Kichiro son yoz hokiz🥴 ! ⛰'

    score-- 
    scoreEl.textContent = score
    return returAgainscore()
  } else {
    messageEl.textContent = 'Maydalashma🙄 ! ⛰'
...
function gameAgain() {
  ...
  messageEl.textContent = 'Boshla uka ...'
...
function youLose(){
  ...
  score = 1
  messageEl.textContent = 'EEE LATTA🤥🤥'
